...
public class StringCodeTest {
    ...
    public void testIntersection() {
        ...
        String b = "abcdiklm";
        int len = 4;
        assertEquals(true, StringCode.stringIntersect(a, b, len));
    }
    ...
    public void testIntersection3() {
        ...
        String b = "abcdiklm";
        int len = 5;
        assertEquals(false, StringCode.stringIntersect(a, b, len));
    }

    @Test
    public void testIntersection_withSpace() {
        String a = "abcxyz";
        String b = "abc xyz";
        int len = 4;
        assertEquals(false, StringCode.stringIntersect(a, b, len));
    ...
    @Test
    public void testIntersection_specialCharacter() {
        String a = ")(-><-";
        String b = "->>-)(";
        int len = 3;
        assertEquals(false, StringCode.stringIntersect(a, b, len));
